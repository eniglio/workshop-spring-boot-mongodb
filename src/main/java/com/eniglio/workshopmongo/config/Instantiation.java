package com.eniglio.workshopmongo.config;
...
import com.eniglio.workshopmongo.dto.AuthorDTO;
import com.eniglio.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Aprovate", sdf.parse("22/03/2018"), new AuthorDTO(bob));
